...
//
//  Created by Justin Maronde on 10/3/22.
//
...
class ResetPasswordController: UIViewController {
    ...
    private let resetPasswordButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(handleResetPasswordButtonAction), for: .touchUpInside)
        return button
    }()
    ...
    @objc func handleResetPasswordButtonAction() {
...
extension ResetPasswordController: FormViewModel {
    func updateForm() {
        ...
        resetPasswordButton.setTitleColor(viewModel.buttonTextColor, for: .normal)
